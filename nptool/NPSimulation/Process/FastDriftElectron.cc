...
#include <iostream>
////////////////////////////////////////////////////////////////////////////////
DriftElectron::DriftElectron(G4String modelName, G4Region* envelope) : G4VFastSimulationModel(modelName, envelope) {}

////////////////////////////////////////////////////////////////////////////////
DriftElectron::DriftElectron(G4String modelName) : G4VFastSimulationModel(modelName) {}
...
void DriftElectron::DoIt(const G4FastTrack& fastTrack, G4FastStep& fastStep) {
  ...
  if (energy < pair_energy * 1.1) {
    ...
    G4ThreeVector newPos = worldPosition + step_length * driftDir;
    // trans drift
    newPos += G4RandGauss::shoot(0, sigmaTrans) * TransDir;
    newPos += G4RandGauss::shoot(0, sigmaLong) * LongDir;
    G4ThreeVector Dir = worldPosition - newPos;

    // Set the end of the step conditions
    fastStep.SetPrimaryTrackFinalKineticEnergyAndDirection(energy, Dir.unit(), false);
