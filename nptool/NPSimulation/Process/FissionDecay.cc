...
using namespace NPS;
////////////////////////////////////////////////////////////////////////////////
FissionDecay::FissionDecay(G4String modelName, G4Region* envelope) : G4VFastSimulationModel(modelName, envelope) {
  m_PreviousEnergy = 0;
  m_PreviousLength = 0;
...
////////////////////////////////////////////////////////////////////////////////
FissionDecay::FissionDecay(G4String modelName) : G4VFastSimulationModel(modelName) {}
...
void FissionDecay::DoIt(const G4FastTrack& fastTrack, G4FastStep& fastStep) {
  ...
  G4bool IsFissionDecay = m_FissionDecay.GenerateEvent(NPL::ChangeNameFromG4Standard(m_CurrentName), m_ExcitationEnergy,
                                                       energy, pdirection.x(), pdirection.y(), pdirection.z(),
                                                       FissionFragment, Ex, DEK, DPx, DPy, DPz, TKE, KE1, KE2);
  ...
  if (IsFissionDecay) {
    ...
    for (unsigned int i = 0; i < size; i++) {
      ...
      fastStep.CreateSecondaryTrack(DynamicFissionFragment, worldPosition, time);
    }
