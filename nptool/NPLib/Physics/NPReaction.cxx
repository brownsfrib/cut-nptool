...
bool Reaction::CheckKinematic() {
  ...
  if (std::isnan(pCM_3) || std::isnan(pCM_4)) {
    return false;
  }
...
double Reaction::ReconstructRelativistic(double EnergyLab, double ThetaLab, double PhiLab) {
  ...
  fEnergyImpulsionLab_3 = TLorentzVector(p_Lab_3 * sin(ThetaLab) * cos(PhiLab), p_Lab_3 * sin(ThetaLab) * sin(PhiLab),
                                         p_Lab_3 * cos(ThetaLab), E3);
...
TLorentzVector Reaction::LorentzAfterReactionHeavy(double EnergyLab, double ThetaLab, double PhiLab) {
  double E3 = m3 + EnergyLab;
  double p_Lab_3 = sqrt(E3 * E3 - m3 * m3);
  fEnergyImpulsionLab_3 = TLorentzVector(p_Lab_3 * sin(ThetaLab) * cos(PhiLab), p_Lab_3 * sin(ThetaLab) * sin(PhiLab),
                                         p_Lab_3 * cos(ThetaLab), E3);
...
TLorentzVector Reaction::LorentzAfterReactionLight(double EnergyLab, double ThetaLab, double PhiLab) {
  double E3 = m3 + EnergyLab;
  double p_Lab_3 = sqrt(E3 * E3 - m3 * m3);
  fEnergyImpulsionLab_3 = TLorentzVector(p_Lab_3 * sin(ThetaLab) * cos(PhiLab), p_Lab_3 * sin(ThetaLab) * sin(PhiLab),
                                         p_Lab_3 * cos(ThetaLab), E3);
  return fEnergyImpulsionLab_3;
}
...
void Reaction::SetParticle3(double EnergyLab, double ThetaLab, double PhiLab) {
  ...
  fEnergyImpulsionLab_3 = TLorentzVector(p3 * sin(ThetaLab) * cos(PhiLab), p3 * sin(ThetaLab) * sin(PhiLab),
                                         p3 * cos(ThetaLab), EnergyLab + m3);
  fEnergyImpulsionLab_4 = fTotalEnergyImpulsionLab - fEnergyImpulsionLab_3;
